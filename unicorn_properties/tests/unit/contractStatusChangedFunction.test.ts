...
import { lambdaHandler } from "../../src/properties_service/contractStatusChangedFunction";
...
describe('Unit tests for contract creation', function () {
    ...
    test('verifies successful response', async () => {
        ...
        async function verifyInput(input: any) {
            ...
            expect(cmd['ExpressionAttributeValues'][':t'].S).toEqual(dateToCheck.toISOString());
            return {
                $metadata: {
                    httpStatusCode: 200
                }
