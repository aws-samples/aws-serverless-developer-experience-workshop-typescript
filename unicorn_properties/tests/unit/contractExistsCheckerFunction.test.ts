...
import { lambdaHandler, ContractStatusNotFoundException } from "../../src/properties_service/contractExistsCheckerFunction";
import { mockClient } from "aws-sdk-client-mock";
import { DynamoDBClient, GetItemCommandInput, UpdateItemCommandInput } from "@aws-sdk/client-dynamodb";
...
describe('Unit tests for contract status checking', function () {
    ...
    test('verifies contract exists check', async () => {
        ...
        let expectedBody = JSON.stringify({"contract_id": "contract1", "property_id": "PROPERTY/australia#sydney/low#23", "contract_status": "Draft"})
    ...
    test('verifies no contract check', async () => {
        ...
        try {
            ...
            expect((error as ContractStatusNotFoundException).statusCode).toEqual(400);            
        }
    });
