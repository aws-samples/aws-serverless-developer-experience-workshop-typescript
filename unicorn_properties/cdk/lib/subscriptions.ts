...
export class SubscriptionsStack extends Stack {
    constructor(scope: App, id: string, props: SubscriptionsStackProps) {
        ...
        const contractsEventBus = events.EventBus.fromEventBusName(this, 'UnicornContractsEventBus', eventBusName(props.stage, UNICORN_NAMESPACES.CONTRACTS));
        const propertiesEventBus = events.EventBus.fromEventBusName(this, 'UnicornPropertiesEventBus', eventBusName(props.stage, UNICORN_NAMESPACES.CONTRACTS));
        ...
        const unicornPropertiesSubscriptionRole = new Role(this, 'UnicornPropertiesSubscriptionRole', {
                ...
                PutEventsOnUnicornPropertiesEventBus: new PolicyDocument({
                    statements: [
                        new PolicyStatement({
                            ...
                            resources: [
                                propertiesEventBus.eventBusArn
                            ]
                        })
                    ]
                })
        ...
        const contractStatusChangedEvents = new events.Rule(this, 'ContractStatusChangedSubscriptionRule', {
            ...
            targets: [
                new targets.EventBus(propertiesEventBus, { role: unicornPropertiesSubscriptionRole })
            ],
        })

        // UNICORN WEB EVENT SUBSCRIPTIONS
        const publicationApprovalRequestedEvents = new events.Rule(this, 'PublicationApprovalRequestedSubscriptionRule', {
